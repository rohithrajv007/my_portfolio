...
export default function HomePage({ navigateTo }) {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative w-full py-8 sm:py-12 lg:py-16 xl:py-20 2xl:py-24 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 bg-slate-900/30">
        <motion.div className="w-full max-w-sm sm:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 xl:gap-10 2xl:gap-12">
            {[
              ...
              <motion.div
                key={idx}
                className="p-4 sm:p-6 lg:p-8 xl:p-10 2xl:p-12 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-xl lg:rounded-2xl border border-slate-700 hover:border-cyan-500/50 transition group h-full"
